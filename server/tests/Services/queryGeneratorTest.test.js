...
test("Should generate perfect query even with false data",()=>{
    expect(queryGenerator.generateSPQuery("sp_CustomerSearch",[false,false,1]))
        .toBe("CALL sp_CustomerSearch('','',1)");
});